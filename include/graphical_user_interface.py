...
class CustomPushButtonBox:
    ...
    @staticmethod
    def add_title(title="my_title", font="Arial", size=15, color="black"):
        my_label = CustomLabel(text=title)
        my_label.customize(font=font, size=size, color=color)
        return my_label

    @staticmethod
    def add_button(name="my_button", min_width=100, min_height=20, font="Arial", font_size=8):
        unit_button = CustomPushButton(name=name)
        unit_button.setMinimumWidth(min_width)
        unit_button.setMinimumHeight(min_height)
        unit_button.setFont(QFont(font, font_size))
        return unit_button

    @staticmethod
    def customize_style(color='black', border_width=1, border_radius=10.0, background_clr=None):
        border_style = "outset"
    ...
    def update_layout(self, obj_in) -> None:
        self.my_layout.update_layout(obj_in)
...
class ClassicView(QMainWindow):
    ...
    def __signal_generator_setup(self, display=True):
        ...
        butt_1 = signal_gen_box.add_button(name="&Single Signal", min_width=min_width_butt,
                                           min_height=min_height_butt, font=local_font, font_size=local_font_size)

        butt_2 = signal_gen_box.add_button(name="&Multiple signal", min_width=min_width_butt,
                                           min_height=min_height_butt, font=local_font, font_size=local_font_size)

        butt_3 = signal_gen_box.add_button(name="Set &noise", min_width=min_width_butt,
                                           min_height=min_height_butt, font=local_font, font_size=local_font_size)

        butt_4 = signal_gen_box.add_button(name="&Reset", min_width=min_width_butt,
                                           min_height=min_height_butt, font=local_font, font_size=local_font_size)

        signal_gen_box.update_layout(butt_1)
        signal_gen_box.update_layout(butt_2)
        signal_gen_box.update_layout(butt_3)
        signal_gen_box.update_layout(butt_4)
    ...
    def __load_file_setup(self, display=True):
        ...
        butt_1 = signal_load_box.add_button(name="Select &file", min_width=min_width_butt,
                                            min_height=min_height_butt, font=local_font, font_size=local_font_size)

        butt_2 = signal_load_box.add_button(name="Select &signal", min_width=min_width_butt,
                                            min_height=min_height_butt, font=local_font, font_size=local_font_size)

        butt_3 = signal_load_box.add_button(name="Reset", min_width=min_width_butt,
                                            min_height=min_height_butt, font=local_font, font_size=local_font_size)

        signal_load_box.update_layout(butt_1)
        signal_load_box.update_layout(butt_2)
        signal_load_box.update_layout(butt_3)
    ...
    def __signal_spectral_setup(self, display=True):
        ...
        butt_2 = signal_spectral_box.add_button(name="Periodogram", min_width=min_width_butt,
                                                min_height=min_height_butt, font=local_font, font_size=local_font_size)

        butt_3 = signal_spectral_box.add_button(name="Welch", min_width=min_width_butt,
                                                min_height=min_height_butt, font=local_font, font_size=local_font_size)

        butt_4 = signal_spectral_box.add_button(name="Correlogram", min_width=min_width_butt,
                                                min_height=min_height_butt, font=local_font, font_size=local_font_size)

        butt_5 = signal_spectral_box.add_button(name="Reset", min_width=min_width_butt,
                                                min_height=min_height_butt, font=local_font, font_size=local_font_size)

        signal_spectral_box.update_layout(butt_1)
        signal_spectral_box.update_layout(butt_2)
        signal_spectral_box.update_layout(butt_3)
        signal_spectral_box.update_layout(butt_4)
        signal_spectral_box.update_layout(butt_5)
    ...
    def __filter_design_setup(self, display=True):
        ...
        butt_1 = filter_design_box.add_button(name="FIR Design", min_width=min_width_butt,
                                              min_height=min_height_butt, font=local_font, font_size=local_font_size)

        butt_2 = filter_design_box.add_button(name="IIR Design", min_width=min_width_butt,
                                              min_height=min_height_butt, font=local_font, font_size=local_font_size)

        butt_3 = filter_design_box.add_button(name="Reset", min_width=min_width_butt,
                                              min_height=min_height_butt, font=local_font, font_size=local_font_size)

        filter_design_box.update_layout(butt_1)
        filter_design_box.update_layout(butt_2)
        filter_design_box.update_layout(butt_3)
...
class UniformView(QMainWindow):
    ...
    def __signal_generator_setup(self, display=True):
        ...
        butt_1.setStyleSheet(main_style)
        butt_2.setStyleSheet(main_style)
        butt_3.setStyleSheet(main_style)
        butt_4.setStyleSheet(main_style)
    ...
    def __signal_spectral_setup(self, display=True):
        ...
        butt_3.setStyleSheet(main_style)
        butt_4.setStyleSheet(main_style)
        butt_5.setStyleSheet(main_style)
    ...
    def __setup_example_1(self, display=False):
        """
        Example of grid configuration
        :return: Vertical layout
        """
    ...
    def __color_background_setup(self, display=True):
        ...
        grey_widget_one = CustomColor(color='gainsboro')
        grey_widget_one.setMinimumWidth(min_width)

        grey_widget_two = CustomColor(color='gainsboro')
        grey_widget_two.setMinimumWidth(min_width)

        grey_widget_three = CustomColor(color='gainsboro')
        grey_widget_three.setMinimumWidth(min_width)

        grey_widget_four = CustomColor(color='gainsboro')
        grey_widget_four.setMinimumWidth(min_width)

        grey_light_widget = CustomColor(color='gainsboro')
        # grey_widget = CustomColor(color='grey')
        empty_widget = QWidget()

        if display:
            self.__grid_layout_setup_for_widget(grey_widget_one, row=0, col=4)
            self.__grid_layout_setup_for_widget(grey_widget_two, row=0, col=5)

            self.__grid_layout_setup_for_widget(grey_widget_three, row=1, col=4)
            self.__grid_layout_setup_for_widget(grey_widget_four, row=1, col=5)
...
def main():
    ...
    gui.show_main_window(max_view_size=False)
